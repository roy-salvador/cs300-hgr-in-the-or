...
class DemoDNN:
    def __init__(self):
        ...
        print(
            "Compiling prediction function took "
    ...
    def build_c3d_model(self, input_var=None):
        ...
        net["input"] = InputLayer(
            (None, self.channels, self.depth, self.img_rows, self.img_cols),
            input_var=input_var,
        )  # with depth channel
        ...
        net["fc8-1"] = DenseLayer(
            net["fc7_dropout"], num_units=self.jester_num_classes, nonlinearity=None
        )
